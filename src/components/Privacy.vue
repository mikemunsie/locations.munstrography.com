<template>
  <div id="en" class="tab-content translations-content-item en visible">
    ...
    <ul>
      ...
      <li>
        <p>
          ...
          "Us" or "Our" in this Agreement) refers to Location Sharing.
        </p>
      </li>
      <li>
        <p>
      ...
      <li>
        <p>
          <strong>Website</strong> refers to Location Sharing, accessible from
          <a
            href="https://locations.munstrography.com"
            rel="external nofollow noopener"
            target="_blank"
            >https://locations.munstrography.com</a
          >
        </p>
      </li>
      <li>
    ...
    <ul>
      <li>By email: munstrography@gmail.com</li>
    </ul>
  </div>
</template>
